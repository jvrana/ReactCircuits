...
function NORGate(props) {
    return <g transform={"translate(" + props.x + "," + props.y + ")"}><g>
...
function Wire(props) {
    ...
    return <g>
        ...
        <line x1={props.midX} x2={props.midX} y1={props.fromY} y2={props.toY} stroke={props.color} strokeWidth={props.strokeWidth}></line>
